...
\setgrefactor{14}
\printgabc[\normalsize]{Resp. 4}{7.}{R}{re--recessit_pastor--solesmes}
...
\prayer{Quo perduxérunt illas scrutatiónes suas, quas perscrutántes defecérunt, ut étiam mórtuo Dómino et sepúlto, custódes pónerent ad sepúlcrum?
...
For they said to Pilate: That deceiver, by which name the Lord Jesus Christ was called, to the comfort of His servants, when they are called deceivers. So they said to Pilate, that deceiver said, while still alive: After three days I will rise again.
...
Pilate said to them: Ye have a watch; go your way; make it as sure as ye can. So they went and made the sepulchre sure, sealing the stone, and setting a watch.}
\end{parcolumns}

\bigskip\bigskip

\printgabc[\normalsize]{Resp. 5}{8.}{O}{re--o_vos_omnes--solesmes}
...
%,colwidths={1=265pt}
\begin{parcolumns}[rulebetween]{2}
\prayer{Posuérunt custódes mílites ad sepúlcrum.
...
But the same love of money that enslaved that disciple and companion of Christ, enslaved also the soldier gaurding the sepulchre.
...
What didst thou say, O stupid cunning?
...
\printgabc[\normalsize]{Resp. 6}{4.}{E}{re--ecce_quomodo_moritur--solesmes}

\translation[\normalsize]{\Rbar{}. Behold how the righteous dieth, and no man taketh it to heart; and the just are taken away, and none considereth. The righteous is taken away from that which is evil;
...
\Rbar{}. Behold how the righteous\dots}
}