...
\def\anttranslation{Be ye lifted up, O eternal gates, and the King of glory shall enter in.\pagebreak}
...
\def\postpsalmtitle{\bigskip}
\def\prepsalmverses{\bigskip\smallskip}
...
\myrespsize
{\label{resp4_recessit_pastor}
\printgabc{Resp. 4}{7.}{R}{re--recessit_pastor--solesmes}
}
{
\translationcolumns[\mytranslationsize]{\Rbar{}~Our Shepherd has withdrawn, the fount of living water, at whose passing the sun was darkened:
...
%\begin{parcolumns}[rulebetween,colwidths={1=0.45\linewidth}]{2}
\tenebraelesson{Quo}{perduxérunt illas scrutatiónes suas, quas perscrutántes defecérunt, ut étiam mórtuo Dómino et sepúlto, custódes pónerent ad \emph{sepúlcrum}?
...
{
\translationcolumns[\mytranslationsize]{\Rbar{}~O all ye that pass by, behold and see:
* If there be any sorrow like unto My sorrow.
\Vbar{}~Attend, O all ye peoples, and see My sorrow:
\Rbar{}~If there be any sorrow like unto My sorrow.}
}

\alternatemusicintrobreak[four]

\pagebreak

\label{o_vos_omnes_poly}
...
\tenebraelesson{Posuérunt}{custódes mílites ad sepúlcrum.
...
\pagebreak
\myrespsize
{\label{resp6_ecce_quomodo_moritur}
\printgabc{Resp. 6}{4.}{E}{re--ecce_quomodo_moritur--solesmes}
}
{
\translationcolumns[\mytranslationsize]{\Rbar{}~Behold how the Just dieth, and none taketh it to heart; and just men are taken away, and none considereth. The Just is taken away from the face of iniquity:
