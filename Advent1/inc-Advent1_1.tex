...
\newcommand{\maganttex}{an--ecce_nomen_domini--solesmes}
\newcommand{\maganttranslation}{Behold, the name of the Lord cometh from far, and the whole earth is full of His glory.}
\def\magsolemn{F}
\definemag{1}{f}
