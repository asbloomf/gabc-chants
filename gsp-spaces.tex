...
%default%\greintersyllablespace= 28000 sp plus 35000 sp minus 0 sp
% space before custo
...
% minimum space between two notes of different syllables
\greintersyllablespace= 25000 sp plus 3000 sp minus 3000 sp
% space after at the end of a word when the last written symbol is a note and the first is a note
\greinterwordspacenotes = 25000 sp plus 9600 sp minus 3000 sp
% space after at the end of a word when the last written symbol is a note and the first is text
\greinterwordspacenotestext = 25000 sp plus 30000 sp minus 3000 sp
% space after at the end of a word when the last written symbol is text and the first is a note
\greinterwordspacetextnotes = 25000 sp plus 30000 sp minus 3000 sp
% space after at the end of a word when the last written symbol is text and the first is text
\greinterwordspacetext = 25000 sp plus 45000 sp minus 3000 sp
...
\gremaximumspacewithoutdash = 1400 sp
...
\grespacelinestext = 76500 sp plus 0 sp minus 0 sp
%\grespacelinestext = 93500 sp plus 0 sp minus 0 sp
