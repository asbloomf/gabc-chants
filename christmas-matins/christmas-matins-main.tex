...
\newcommand{\lessontitle}[2]{%
	\noindent\hspace{10ex}{Lesson #1.}\hfill\emph{#2.}\hspace{10ex}
}
...

{
	...
	includes the Sacraments, various rites of blessings, but in particular the Holy Sacrifice of the Mass and the Divine Office.
...
\newcommand{\printinvitatoryant}{
	...
	\gregorioscore{in-ChristusNatusEst}	
}
\newcommand{\printinvitatoryantparttwo}{
	\gregorioscore{in-VeniteAdoremus}
}
...
{
	\printinvitatoryant{}
	\translation{Christ is born to us: Come, let us worship.}
...
}{}
{
	...
	\gregorioscore{in-ps94-1-Venite}
	\translation{Come let us praise the Lord with joy: let us joyfully sing to God our saviour. Let us come before his presence with thanksgiving; and make a joyful noise to him with psalms.}
...
}{}
{
	...
	\gregorioscore{in-ps94-2-QuoniamDeus}
	\translation{For the Lord is a great God, and a great King above all gods. For the Lord will not cast off his people: for in his hand are all the ends of the earth, and the heights of the mountains are his.}
...

{
	...
	\alsetinitialspacing{Q}
	\gregorioscore{in-ps94-3-QuoniamIpsius}
	\translation{For the sea is his, and he made it: and his hands formed the dry land. Come let us adore and fall down before God: let us weep before the Lord that made us: For he is the Lord our God: and we are his people and the sheep of his pasture.}
...
}{}
{
	...
	\alsetinitialspacing{Q}
	\gregorioscore{in-ps94-4-Hodie}
	\translation{Today if you shall hear his voice, harden not your hearts: As in the provocation, according to the day of temptation in the wilderness: where your fathers tempted me, they proved me, and saw my works.}
...
}{}
{
	...
	\alsetinitialspacing{Q}
	\gregorioscore{in-ps94-5-Quadraginta}
	\translation{Forty years I endured that generation, and I said: These always err in heart. And these men have not known my ways: so I swore in my wrath that they shall not enter into my rest.}
...
}{}
{
	...
	\alsetinitialspacing{Q}
	\gregorioscore{in-ps94-6-GloriaPatri}
