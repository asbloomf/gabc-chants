...
sopMusic = \relative c' {
  \clef "treble"
  f1_\pp^\<( g2\!) | f1.^\> | f2^\<( g\!) f^\> | f1\! g2 | a( c f | e) d c-^^\< ~ c\! b4( a) b2 | c1. |
  c1.^\< | bf?1^\> bf2^\< | a-^\!( f^\< e\!) | d1. |
  % 1st or 2nd night
  e1.^\< | f1. | g1.\! | af1. | bf2 c df |
  c1. | c1.\fermata \bar "||" f,1^\<^\markup \italic { Tertia nocte additur: } g2 | f1\> f2 | f\<( g\! f) | f1.^\> | a2^\<( c) f\! | e(-^ d) c ~ c b4(-^ a-^ b2-^) | c1. |
