{
  ...
  }
  {
    ...
    \def\printcollectrefs{%
      \def\dotting{\hfill%\leaders\hbox to 1em{\hfil.\hfil}\hfill
        }%
      \begin{multicols}{2}%
      \noindent{}1st Sunday of Advent,\dotting \emph{below}\\
      2nd Sunday of Advent,\dotting \emph{p.~\pageref{advent2-collect}}\\
      3rd Sunday of Advent,\dotting \emph{p.~\pageref{advent3-collect}}\\
      4th Sunday of Advent,\dotting \emph{p.~\pageref{advent4-collect}}
      \end{multicols}%
      \smallskip
    }
  ...
  \def\printshortresp{%
    ...
    {\def\gabcfolder{.}
    \printgabc{Short}{Resp.}{V}{re--hodie_scietis--solesmes_1961}}
