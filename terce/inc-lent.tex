{
...

  {
    \newcommand{\printrefs}[1]{%
	  ...
	  \def\printhymn{
		  \label{hymn-lent}
	  	{\def\gabcfolder{.}
	  	\printgabc{Hymn.}{1.}{N}{hy--nunc_sancte_nobis_(in_quadragesima)--solesmes_1961}}
...

  {
    ...
    \def\printhymn{
      \label{hymn-passiontide}
      {\def\gabcfolder{.}
      \printgabc{Hymn.}{2.}{N}{hy--nunc_sancte_nobis_(in_tempore_passionis)--solesmes_1961}}
  ...
  \def\printhymn{%
    , \emph{Hymn}, p.~\pageref{hymn-passiontide}
