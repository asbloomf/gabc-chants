...
\newcommand{\printcollect}[2]{
	...
	%\smallskip
	\fi
	\ifx\printcollectrefs\undefined\else\printcollectrefs\fi
	\begincollectcols
	\sloppy
	\prayer{#1}{#2}
	\end{parcolumns}
...
\newcommand{\printterce}[2][.]{
	{
		...
		\ifx\printhymn\undefined%
	      \noindent\emph{Hymn}, page \pageref{hymn-sunday}
		...
		\ifx\collectlabel\undefined\else\collectlabel\let\collectlabel=\undefined\fi
