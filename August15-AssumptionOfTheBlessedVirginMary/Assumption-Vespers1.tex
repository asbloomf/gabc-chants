...
\newcommand{\chaptertext}{\dropcap{latin}{Benedíxit te Dóminus in virtúte sua, quia per te ad níhilum redégit inimícos} \textbf{nó}\-stros.~\gredagger{} Benedícta es tu, fília, a Dómino De\-\emph{o ex}\-\textbf{cél}\-so,~* præ ómnibus muliéribus super \textbf{tér}\-ram.}
...
\newcommand{\vrtex}{vrExaltata.tex}
...
\normalsize
%\pagebreak
{\greseteolcustos{manual}\grechangestaffsize{16}
\normalsize
...
\gresetfirstlineaboveinitial{\small \Vbar{}}{\small \Vbar{}}
\setsecondannotation{}\greseteolcustos{manual}
