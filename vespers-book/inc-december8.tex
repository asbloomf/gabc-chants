...
\def\prevr{\printnote{%
        ...
        \begin{multicols}{2}%
        \noindent{}Feb.~1 \& 2,\dotting \emph{\Vbar{}~Respónsum}, p.~\pageref{vr-feb2}\\
March 24 \& 25,\dotting \emph{\Vbar{}~Ave María}, p.~\pageref{vr-march25}\\
Aug.~14 \& 15,\dotting \emph{\Vbar{}~Exaltáta est}, p.~\pageref{vr-assumption}%
\ifthenelse{\boolean{includeoct11}}{\\
  Oct.~10 \& 11,\dotting \emph{\Vbar{}~Benedícta tu}, p.~\pageref{vr-october11}
}{}
        \end{multicols}%
        }}
...
\printvespers[../December8-ImmaculateConception]{inc-ImmaculateConceptionVespers}
  ...
  \bigskip
  \noindent
  \printnote{Then follows a Commemoration of the Advent Sunday or Feria.  The antiphon is followed by \emph{\Vbar{} Roráte cæli}, page \pageref{vr-rorate-dec8}, and then the appropriate Collect, page \pageref{collect-dec8}.}
  \bigskip
  }

  {
    ...
    {
    \bigskip
    {\centering{}Second Sunday of Advent.\par}
    \medskip
    \def\gabcfolder{../Advent2}
    \input{\gabcfolder/CommemorationAdvent2}
    \ifthenelse{\boolean{birmingham}}{
