...
\noindent
\printnote{\commemorations{}  Otherwise \Vbar~\emph{Benedicámus Dómino \benedicamusdominonameeaster{}}, page \pageref{benedicamusdomino-#1}.}
}
{
...
\newcommand{\printcommonvespers}[1][2]{
    \subtitle{\nth{#1} Class}
    \printnote{From \emph{Vespers of Sundays in Paschaltide}, page \pageref{sundayvespers-easter}.\\}
}
{
...
\def\begincollectcols{\vspace{-0.5\baselineskip}\begin{parcolumns}[rulebetween,colwidths={1=0.46\linewidth}]{2}}
