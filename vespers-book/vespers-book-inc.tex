...
\grechangestaffsize{15}
{
	...
	\ifthenelse{\boolean{birmingham}}{% birmingham
		...
		\ifthenelse{\boolean{stlouis}}{%
			...
			\includesvg[width=0.5\linewidth]{SsGregoryAndAugustineFullLogo_Black}
	...
	\noindent{}In this newest edition, I have changed the way 4A* and 8G* endings are notated.  Since I have found out that these endings are optional, I have retained the indication, but give the psalm tone for the normal 4A and 8G endings.  If you do wish to employ the optional ending, simply go up one whole step at the end of the verse to the TI for 4A* or the LA for 8G*.
...
%editions
	\bigskip{}\noindent{}%
	\ifthenelse{\boolean{stlouis}}{%
		Ss Gregory \& Augustine edition, December 2020
		...
		{% true
		  ...
		  \ifthenelse{\boolean{onlysundaycommon}}{
			    ...
			    \noindent{}Sixth edition, 9 December 2020.
