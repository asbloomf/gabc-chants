...
\grechangestaffsize{15}
{
	...
	\ifthenelse{\boolean{birmingham}}{% birmingham
		...
		{\Huge
		Sunday\ifthenelse{\boolean{onlysundaycommon}}{}{s \& Holy Days}
	...
	\ifthenelse{\boolean{birmingham}}{
		...
		\noindent{}Vespers with Gregorian Chant for Sunday\ifthenelse{\boolean{onlysundaycommon}}{}{s \& Holy Days}: \emph{newly typeset, based on \emph{The Liber Usualis}, edited by the Benedictines of Solesmes (Desclee Company, 1961).}
	}
...
\makeatletter
	\noindent{}Typeset using \LuaLaTeX{},\ifthenelse{\boolean{birmingham} \or \boolean{onlysundaycommon}}{}{Lilypond version 2.19.64,} and Gregorio version \gre@gregoriotexversion{}
\makeatother
...
\ifthenelse{\boolean{birmingham} \or \boolean{onlysundaycommon}}{% true
