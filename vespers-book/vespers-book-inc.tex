...
%editions
	...
	{% true
	  ...
	  \ifthenelse{\boolean{onlysundaycommon}}{
		    ...
		    \noindent{}Sixth edition, 11 November 2020.
...
\makeatletter
	\noindent{}Typeset using \LuaLaTeX{},\ifthenelse{\boolean{birmingham} \or \boolean{onlysundaycommon}}{}{ Lilypond version 2.20.0,} and Gregorio version \gre@gregoriotexversion{}
\makeatother
