...
\def\definevesperspropers{\input{\gabcfolder/inc-StsPeterAndPaul-2Vespers}
  ...
  \ifthenelse{\boolean{birmingham}}{
    ...
    \def\prepsalmtitlefive{\bigskip\bigskip}
    %\def\postpsalmtitlefive{\needspace{8\baselineskip}}
  }{
...
\def\definevesperspropersalt{\input{\gabcfolder/inc-StsPeterAndPaul-1Vespers}
  ...
  \ifthenelse{\boolean{birmingham}}{
    ...
    %\def\preanttranslationfive{\vspace{-0.2\baselineskip}}
...
\def\prevesperspsalms{\noindent\printnote{Chapter and following, page \pageref{june29-chapter}.\ifthenelse{\boolean{birmingham}}{}{\\}}}
