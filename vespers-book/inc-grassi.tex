...
\ifthenelse{\boolean{lettersize}}{
	\includelilypond{magnificat-grassi_letter-systems}
}{
	\includelilypond{magnificat-grassi-small-systems-page1}
}
\pagebreak
...
\ifthenelse{\boolean{lettersize}}{
	...
	\includelilypond{magnificat-grassi-small-systems-page2}
}
}