...
\geometry{outer=0.4in,inner=0.85in,top=0pc+\headheight+\headsep,bottom=1pc+\footskip,twoside=true}
\newpagestyle{main}{
...
\titlespacing{\chapter}{0pt}{-40pt}{1pc}
...
%TODO where should I try and put the grassi? And I'll have to reformat it for the right size
