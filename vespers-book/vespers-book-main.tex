...
\newcommand{\printcommemoration}[2][.]{
	...
	\bigskip
	\printvr[\greblockcustos]{\commvrtex}
	{\commvtranslation}
	{\commrtranslation}
...
\setgrefactor{15}
	...
	{
	\ifx\definevone\undefined\else{
		\definevone
	    \begin{center}{\large Magnificat.}\end{center}
    	\vspace{-1ex}
		\printnote{At 1st Vespers the Magnificat is as follows.  For 2nd Vespers look after.\\}
	...
	\ifx\definevtwo\undefined\else
		\definevtwo
		\printnote{At 2nd Vespers the Magnificat is as follows.\\}
		\def\nomagtitle{T}
	\fi
	\let\anttranslation=\maganttranslation
	\let\preverses=\premagverses
