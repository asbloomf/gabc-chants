...
\grechangestaffsize{15}
{
	...
	% copyright page
	\thispagestyle{empty}
	\noindent{}Vespers with Gregorian Chant for Sundays \& Holy Days: \emph{newly tyseset, based on \emph{The Liber Usualis}, edited by the Benedictines of Solesmes (Desclee Company, 1961).}
