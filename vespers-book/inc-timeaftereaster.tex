...
\newcommand{\printhymnnote}{
    ...
    \ifthenelse{\boolean{preurbanhymns}}{
        \def\easterhymntitle{Ad cœnam Agni próvidi}
    }{
        \def\easterhymntitle{Ad Régias Agni Dapes}
    }
    \noindent\printnote{Hymn.~\emph{\easterhymntitle}, page \pageref{hymn-adregiasagnidapes}.
...
\ifthenelse{\boolean{preurbanhymns}}{
    \def\ascensionhymntitle{Jesu nostra redémptio}
}{
    \def\ascensionhymntitle{Salútis humánæ Sator}
}
{
...
\renewcommand{\printhymnnote}{
    \medskip
    \noindent\printnote{Hymn.~\emph{\ascensionhymntitle}, page \pageref{hymn-salutishumanaesator}.}
    \medskip
    \def\vrlinebreak{T}
