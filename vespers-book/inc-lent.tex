...
\newcommand{\printcommonvespers}[1][2]{
	...
	\deusinadjutorium{}
	\printnote{\emph{Vespers of Sundays throughout the year}, p.~\pageref{sundayvespers}.\\}
}
...
\renewcommand{\printcommonvespers}[1][2]{
	\subtitle{\nth{#1} Class}
	\deusinadjutorium{}
	\printnote{\emph{Vespers of Sundays throughout the year}, page \pageref{sundayvespers}.\\}
}
