...
\noindent\printnote{\commemorations{}
	\ifthenelse{\boolean{includebenedicamusdominoreferences}}{
		Otherwise \benedicamusdominoreference{lent}%
	}{}
	}
}
{
...
\def\commemorations{If today is 18 or 19 March, \emph{First Vespers of St Joseph} is commemorated as follows.}
\printcommemnote{}
}
...
\def\commemorations{If today is 18 or 19 March, \emph{First Vespers of St Joseph} is commemorated as on page \pageref{stjoseph-commem}.  If today is 24 or 25 March, \emph{First Vespers of the Annunciation} is commemorated as follows.}
\printcommemnote{}
}
...
\def\commemorations{If today is 18 or 19 March, \emph{First Vespers of St Joseph} is commemorated as on page \pageref{stjoseph-commem}.  If today is 24 or 25 March, \emph{First Vespers of the Annunciation} is commemorated as on page \pageref{annunciation-commem}.}
{
\section{\nth{4} Sunday of Lent}
\label{lent4}
