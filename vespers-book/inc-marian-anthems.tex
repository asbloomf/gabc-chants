...
\ifthenelse{\boolean{birmingham}}{
  \printnote{
    \emph{Alma Redemptoris Mater} is sung from \nth{1} Vespers of the First Sunday of Advent until \nth{2} Vespers of 2 February.

    \emph{Ave Regina Cælorum} is sung from Compline of 2 February until Compline of Holy Wednesday.

    \emph{Regina Cæli} is sung from Compline of Holy Saturday until None of the Saturday within the Octave of Pentecost.

    \emph{Salve Regina} is sung from \nth{1} Vespers of Trinity Sunday until None of the Saturday before the First Sunday of Advent.
  }
}{
  \def\printalmanote{\printnote{From \nth{1} Vespers of the First Sunday of Advent until 2 February at Vespers.}}
  \def\printavereginanote{\printnote{From Compline of 2 February (even if the Feast of the Purification be transferred) until Compline of Wednesday in Holy Week.}}
  \def\printreginacaelinote{\printnote{From Compline of Holy Saturday until None of the Saturday within the octave of Pentecost.}}
  \def\printsalvenote{\printnote{From \nth{1} Vespers of Trinity Sunday until None of the Saturday before the First Sunday of Advent.}}
}
\def\nogabcbreaks{T}
...
\begin{quote}{
Beloved Mother of the Saviour, and wide open Gate of heaven,
...
\ifthenelse{\boolean{onlysundaycommon}}{\vfil\pagebreak}{}
{
\newcommand{\note}{During Advent:}
...
\printgabc{Ant.}{5.}{S}{SalveReginaSimple}
  \bigskip{}
\ifthenelse{\boolean{includesalvewithdrone} \or \boolean{onlysundaycommon}}{
  \salvereginaenglish
  \medskip
}{}
\ifthenelse{\boolean{onlysundaycommon}}{
