...
Alma Redemptoris Mater (from Advent through February 2), \emph{p.~\pageref{almaredemptorismater}.}\\
Ave Regina Cælorum (from February 2 through Lent), \emph{p.~\pageref{avereginacaelorum}.}\\
Regina Cæli (from Easter through the Friday after Pentecost), \emph{p.~\pageref{reginacaeli}.}\\
Salve Regina (from 1st Vespers of Trinity Sunday through the last Saturday before Advent), \emph{p.~\pageref{salveregina}.}
