...
\newcommand{\printmariananthemnote}{
	...
	\noindent{}Alma Redemptoris Mater \emph{(Advent through February 2)},\dotting p.~\pageref{almaredemptorismater}%
...
\ifthenelse{\boolean{onlysundaycommon}}{}{% false
	...
	Salve Regina \emph{(1st Vespers of Trinity Sunday until before Advent)},\dotting p.~\pageref{salveregina}%
	\ifthenelse{\boolean{includepolyphony}}
