...
Alma Redemptoris Mater \emph{(Advent through February 2), p.~\pageref{almaredemptorismater}.}\\
Ave Regina Cælorum \emph{(February 2 through Lent), p.~\pageref{avereginacaelorum}.}\\
Regina Cæli \emph{(Easter through the Friday after Pentecost), p.~\pageref{reginacaeli}.}\\
Salve Regina \emph{(1st Vespers of Trinity Sunday until just before Advent), p.~\pageref{salveregina}.}
