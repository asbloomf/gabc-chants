...
\def\printfullhymn{
...

	{
		...
		\medskip{}
		\emph{On the \nth{2} Sunday of Advent, \emph{Magnificat}, \pageref{advent2-mag}}.

		\emph{On the \nth{3} Sunday of Advent, \emph{Magnificat}, \pageref{advent3-mag}}.

		\emph{On the \nth{4} Sunday of Advent, \emph{Magnificat}, \pageref{advent4-mag}}.
	}
	}
}
