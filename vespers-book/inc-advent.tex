...
%TODO still need to add the versicle and response and the collects
}

{
    ...
    \translation[\normalsize]{
	    \Vbar{}~Roráte cæli désuper, et nubes pluant \textbf{ju}stum.%
	    \\
	    \emph{\Vbar{}~Ye heavens, drop down dew from above, and let the clouds rain down the Just One.}%

	    \smallskip

	    \Rbar{}~Aperiátur terra, et gérminet Salva\textbf{tó}rem.%
	    \\
	    \emph{\Rbar{}~Let the earth open and bud forth the Saviour.}%
	   }
