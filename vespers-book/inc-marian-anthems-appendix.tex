...
\ifthenelse{\boolean{includepolyphony}}{
  ...
  \includelilypond{SalveRegina-systems}%
  ...
  \label{alma_poly}
  \includelilypond{AlmaRedemptorisMater-systems}%
  ...
  \includelilypond{AveReginaCaelorum-systems}%
  ...
  \includelilypond{ReginaCoeli-systems}%
