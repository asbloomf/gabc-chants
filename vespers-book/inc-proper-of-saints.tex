...
\newcommand{\sundaycommemnote}{%
  If today is Sunday, the Vespers of the Sunday is commemorated with \emph{Magnificat antiphon}, \emph{\Vbar{}~Dirigátur.} in simple commemoration tone, p.~\pageref{vr-dirigatur} and \emph{Collect}.

  \benedicamusdominoreference{1}
}
\newcommand{\sundaycommemnoteeaster}{%
  If today is Sunday, the Vespers of the Sunday is commemorated with \emph{Magnificat antiphon}, \emph{\Vbar{}~Mane nobíscum.} in simple commemoration tone, p.~\pageref{vr-manenobiscum} and \emph{Collect}.

  \benedicamusdominoreference{1}
}
\newcommand{\sundaycommemnoteeasterpentecost}{%
  If today is Sunday, the Vespers of the Sunday is commemorated with \emph{Magnificat antiphon}, \emph{\Vbar{}~Mane nobíscum.} in Paschaltide or \emph{\Vbar{}~Dirigátur} after Pentecost in simple commemoration tone, p.~\pageref{vr-manenobiscum} and \emph{Collect}.
...
\noindent
\printnote{If today is October 31, the First Vespers of All Saints is commemorated with \emph{Magnificat antiphon}, p.~\pageref{allsaints1-magnificat}; \emph{\Vbar{}~Lætámini}.~in simple commemoration tone, p.~\pageref{allsaints1-vr}; and \emph{Collect}, p.~\pageref{allsaints-collect}.  Otherwise \benedicamusdominoreference{1}}
\bigskip
\hrule
%\bigskip
%\benedicamusdomino{}
