...
\newcommand{\sundaycommemnote}{%
  If today is Sunday, the Vespers of the Sunday is commemorated with \emph{Magnificat antiphon}, \emph{\Vbar{} Dirigátur.} in simple commemoration tone, p.~\pageref{vr-dirigatur} and \emph{Collect}.  Otherwise \benedicamusdominoreference{1}
}
\newcommand{\sundaycommemnoteeaster}{%
  If today is Sunday, the Vespers of the Sunday is commemorated with \emph{Magnificat antiphon}, \emph{\Vbar{} Mane nobíscum.} in simple commemoration tone, p.~\pageref{vr-manenobiscum} and \emph{Collect}.  Otherwise \benedicamusdominoreference{1}
}
