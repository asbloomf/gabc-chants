...
%\def\preantafter{\grechangestaffsize{17}\normalsize}
%\def\dontrepeatantiphon{T}
%\def\prerepeatantiphon{\vspace{-12pt}}
%\def\prepsalm{\mypsalmsize}
\def\anttranslation{From them that rise up against me deliver me, O Lord: for they have seized my soul.\bigskip}
...
\def\anttranslation{Thou hast put away mine acquaintance far from me; I was delivered up, and came not forth.\bigskip}
...
%\begin{parcolumns}[rulebetween,colwidths={1=0.455\linewidth}]{2}
\tenebraelesson{Festinémus}{íngredi in illam réquiem~: ut ne in idípsum quis íncidat incredulitátis exémplum.
...
\myrespsize
{\label{resp7_tradiderunt}
\printgabc{Resp. 7}{5.}{T}{re--tradiderunt--solesmes}}

{
\translationcolumns[\mytranslationsize]{\Rbar{}~They delivered Me into the hands of the impious, and cast me out among the wicked, and spared not My life: the mighty gathered together against Me
...
%\begin{parcolumns}[rulebetween,colwidths={1=0.481\linewidth},distance=1.2em]{2}
{\tenebraelesson{Adeámus}{ergo cum fidúcia ad thronum grátiae~: ut misericórdiam consequámur, et grátiam inveniámus in auxílio opportúno.
...
{\label{resp8_jesum_tradidit}
\printgabc{Resp. 8}{8.}{J}{re--jesum_tradidit--solesmes}}

{
\translationcolumns[\mytranslationsize]{\Rbar{}~An impious man betrayed Jesus to the chief priests and elders of the people
...
%\begin{parcolumns}[rulebetween,colwidths={1=0.455\linewidth}]{2}
{\tenebraelesson{Nec}{quisquam sumit sibi honórem, sed qui vocátur a Deo, tamquam Aaron.
...
Quem\-ád\-mo\-dum et in álio loco dicit~: Tu es sacérdos in ætérnum secúndum órdinem Mel\-chí\-se\-dech.
...
\pagebreak
\myrespsize
{\label{resp9_caligaverunt}
\printgabc{Resp. 9}{5.}{C}{re--caligaverunt--solesmes}}

\vspace{-0.5\baselineskip}
\translationcolumns[\mytranslationsize]{\Rbar{}~Mine eyes do fail with tears, for He is far from Me that comforted Me. Behold, all ye peoples
