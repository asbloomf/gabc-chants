...
\geometry{outer=35pt,inner=35pt,top=20pt+\headsep+\headheight,bottom=20pt+\footskip}
...
\grechangedim{spacelinestext}{0.8 cm}{scalable}%
...
\large \gregorioscore[a]{\antfilename Solemn\ifx\withdrone\undefined\else\if\withdrone T-drone\fi\fi}}
\if\usetwopages T
\bigskip
\afterant
\pagebreak
...
{\large \gregorioscore[a]{\antfilename Simple}}
\bigskip
\afterant
