\item Quia respéxit humilitátem an\emph{cíl}\emph{lae} \textbf{sú}æ~:~* ecce enim ex hoc beátam me dícent ómnes ge\emph{ne}\emph{ra}\emph{ti}\textbf{ó}nes.
...
\item Depósuit potén\emph{tes} \emph{de} \textbf{sé}de,~* et ex\emph{al}\emph{tá}\emph{vit} \textbf{hú}\textbf{mi}les.
...
\item Sicut locútus est ad \emph{pá}\emph{tres} \textbf{nó}stros,~* Abraham et sémini \emph{é}\emph{jus} \emph{in} \textbf{saé}\textbf{cu}la.
