...
\item Rogáte quæ ad pacem \emph{sunt} \emph{Je}\textbf{rú}salem~:~* et abundántia di\emph{li}\emph{gén}\emph{ti}\textbf{bus}\textbf{bus} te~:
\item Fiat pax in vir\emph{tú}\emph{te} \textbf{tu}a~:~* et abundántia in \emph{túr}\emph{ri}\emph{bus} \textbf{tu}is.
\item Propter fratres meos, et pró\emph{xi}\emph{mos} \textbf{me}os,~* loqué\emph{bar} \emph{pa}\emph{cem} \textbf{de} \textbf{de} te~:
