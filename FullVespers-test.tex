...
\ifx\chapterhymnversicleantiphontex\undefined%
  ...
  \else\hymnreplacement
  \fi
%
\ifx\vrtex\undefined%
    {\Vbar{}~\vr{}.\ifx\magant\undefined\else
...
\else{
    ...
    \fi %vrpttex
    \printvr[\greseteolcustos{manual}\ifx\prevr\undefined\else\prevr\fi]{\vrtex}{\vtranslation}{\rtranslation}
    \bigskip
}\fi%
