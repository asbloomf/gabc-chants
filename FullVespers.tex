...
\alsetinitialspacing{\antthreeinitial}
...
\alsetinitialspacing{\antfourinitial}
...
\alsetinitialspacing{\antfiveinitial}
...
\normalsize%
\ifx\chapterhymnversicleantiphontex\undefined%
\ifx\chaptertranslation\undefined\ifx\nochapter\undefined%
\emph{Chapter. }%
\fi\else%
%\pagebreak[3]
...
\fi%
\ifx\hymntex\undefined\ifx\hymn\undefined\else
{\vspace{-1ex plus 1ex}
\emph{Hymn.} \hymn{}.%
\ifx\vrtex\undefined\else
\vfill
\fi}\fi
\else{% hymntex defined
{%
...
{\gresetinitiallines{0}\greseteolcustos{manual}\gregorioscore{\vrpttex}}
\bigskip
\emph{Per annum:}
...
\bigskip
{\premagverses
\ifx\magoneline\undefined\else\if\magoneline T\greseteolcustos{manual}\fi\fi
...
\ifx\benedicamusnobiginitial\undefined\else
	\if\benedicamusnobiginitial T
		\gresetinitiallines{0}
	\fi
\fi
...
\ifx\benedicamusdominoreplacement\undefined\else\benedicamusdominoreplacement\fi

\ifx\includefideliumanimae\undefined\else\if\includefideliumanimae T%
\bigskip
\begin{parcolumns}[rulebetween]{2}
\selectlanguage{latin}%
\colchunk{\Vbar{}~Fidélium ánimæ per misericórdiam Déi requiéscant in páce.}%\hfill{}\Rbar{}~Amen.}
\selectlanguage{american}%
\colchunk{\Vbar{}~May the souls of the faithful departed through the mercy of God rest in peace.}%\hfill{}\Rbar{}~Amen.}
\selectlanguage{latin}%
\colplacechunks{}
\colchunk{\Rbar{}~Amen.}
\colchunk{\Rbar{}~Amen.}
