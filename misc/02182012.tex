...
%\bigskip
\large \gregorioscore{grad-BenedictaEtVenerabilisRepeatIntonation}}
\bigskip
{\def\annot{Tract.}
\def\annottwo{2. D}
\alsetinitialspacing{G}
\large\gregorioscore{tract-GaudeMariaRepeatIntonation}}
\bigskip
\hrule
\bigskip
{\def\annot{Offert.}
\def\annottwo{1. f}
\alsetinitialspacing{F}
\large\gregorioscore{offert-FelixNamqueEs}}
\end{document}
