...
\geometry{outer=72pt,inner=72pt,top=36pt,bottom=36pt+\footskip}
...
%\chead{\addfontfeature{Numbers=Lining}Magnificat Solemn Tone 7. a.}
...
\includegraphics{magnificat-protodiogenes-7a-crop.pdf}%
%\end{center}
\end{document}
