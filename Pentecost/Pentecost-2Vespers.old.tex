...
% The title:
\vspace*{-11ex}
\begin{center}{\huge 2nd Vespers of Pentecost.}\end{center}
\vspace{-2ex}
...
\chead{2nd Vespers of Pentecost.}
...
%\grechangestaffsize{15}%
\normalsize%
\gregorioscore{Psalm113-7c2.tex}
%\begin{multicols}{2}
%\vspace{-1ex}
%\begin{Parallel}[v]{}{}
...
\gregorioscore{Hymn-VeniCreatorSpiritusvr.tex}
\translation[]{
\Vbar{}~The Apostles spoke in divers tongues.\\
\Rbar{}~The wonderful works of God.
}
\pagebreak
...
\gregorioscore{MagnificatAntiphon2.tex}}%
%\vspace{-2ex}
\translation[]{Today the days of Pentecost are complete, alleluia; today the Holy Ghost appeared in fire to the disciples, gave them gifts and graces, sent them into all the world to preach and to bear witness; whoever believes and is baptised shall be saved, alleluia.}
\smallskip
%\hrule
