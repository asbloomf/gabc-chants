...
\smallskip
\large
\gregorioscore{deusinadjutorium_solemn}}%
...
\item Sicut érat in princípio, et núnc, et \textbf{sém}per,~* et in sǽcula sæcu\textbf{ló}rum. \textbf{A}men.\end{psalmverses}
}
\selectlanguage{american}
...
\large
\gregorioscore{Hymn-PangamusNerio}
\normalsize
\selectlanguage{american}
\begin{multicols}{2}
\begin{psalmverses}
...
\gregorioscore{vrDeusVirtutumPT}
\translation[]{
...
\gresetfirstlineaboveinitial{\small \Vbar{}}{\small \Vbar{}}
\gregorioscore{BenedicamusDomino_1class1stvespers}
