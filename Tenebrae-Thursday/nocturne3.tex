...
\let\preantafter=\undefined
\def\psalmtranslationsmall{T}
\def\anttranslation{The earth trembled and was still, when God arose to judgment.}
...
\let\preantafter=\undefined
\def\psalmtranslationsmall{T}
\def\anttranslation{In the day of my trouble I sought God with my hands.}
\printpsalm{3}{76}{7a}{an--in_die_tribulationis--solesmes}{I}

\bigskip%\pagebreak
\printvr{vr-ExsurgeDomine}{Arise, O Lord.}
{And judge my cause.}
...
\end{center}
{
\hspace{10ex}\textsc{lesson vii}\hfill\emph{Chap. ii, 17-34}\hspace{10ex}
\begin{parcolumns}[rulebetween]{2}
\prayer{Hoc autem præcípio~: non laudans quod non in mélius, sed in detérius convenítis.
...
\printgabc[\normalsize]{Resp. 7}{7.}{E}{re--eram_quasi_agnus--solesmes}

\translation[\normalsize]{\Rbar{}. I was like a gentle lamb that is brought to the slaughter, and I knew not that mine enemies had devised devices against me, saying
* Come, let us put (poison of a deadly) tree into his bread, and let us cut him off from the land of the living.
\Vbar{}. All mine enemies devised my hurt against me: they plotted together to do me evil, saying:
\Rbar{}. Come, let us put (poison of a deadly) tree into his bread, and let us cut him off from the land of the living.}

\begin{center}{\textsc{lesson viii}}\end{center}

\begin{parcolumns}[rulebetween]{2}
\prayer{Ego enim accépi a Dómino quod et trádidi vobis, quóniam Dóminus Jesus, in qua nocte tradebátur, accépit panem,
et grátias agens fregit, et dixit~: «Accipite et manducáte~: hoc est corpus meum, quod pro vobis tradétur~: hoc fácite in meam commemoratiónem».
...
\printgabc[\normalsize]{Resp. 8}{7.}{U}{re--una_hora--solesmes}
...
\begin{parcolumns}[rulebetween]{2}
\prayer{Itaque quicúmque manducáverit panem hunc vel bíberit cálicem Dómini indígne, reus erit córporis et sánguinis Dómini.
...
\printgabc[\normalsize]{Resp. 9}{1.}{S}{re--seniores--solesmes}

\translation[\normalsize]{\Rbar{}. The elders of the people consulted
* That they might take Jesus by subtlety, and kill Him: they came out, as against a thief, with swords and staves.
\Vbar{}. The chief Priests and the Pharisees gathered a council.
\Rbar{}. That they might take Jesus by subtlety, and kill Him: they came out, as against a thief, with swords and staves.
