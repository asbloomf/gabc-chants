...
{
\ifnotbook{\def\preant{\setgrefactor{16}\normalsize}}
\ifbook{\def\preant{\setgrefactor{17}\large}
...
\ifnotbook{\def\prepsalm{\setgrefactor{14}\normalsize}}
\ifbook{\def\prepsalm{\setgrefactor{15}\normalsize\greblockcustos}}
...
\ifnotbook{\def\prepsalm{\setgrefactor{16}\normalsize\greblockcustos}}
...
\bigbreak\bigbreak
\emph{Alternately, the following three part arrangement can be sung in place of the chant.}
\pagebreak
{
\noindent
...
\import{lilypond/}{in_monte_oliveti-systems}
}
...
\noindent
\import{lilypond/}{tristis_est_anima_mea-systems}
}
